...
\subsubsection{Rechenregeln}
\begin{enumerate}
    \item \textbf{Linearität:} Seien $f,g:[a,b] \rightarrow \mathbb{R}$ zwei (Riemann-)integrierbare Funktionen, und seien $\alpha, \beta \in \mathbb{R}$. Dann ist auch $\alpha f + \beta g$ integrierbar und es gilt
...
\end{enumerate}
\textit{\textbf{Beweise für Rechenregeln:} "Was passiert für Treppenfunktionen?", dann Approximations-Idee.}
...
\textit{Gilt auch für Funktionen die in endlich vielen Stellen nicht monoton oder stetig sind (wegen Aufteilung des Integrationsbereichs).}
